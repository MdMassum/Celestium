...
const MobileNav: React.FC = () => {
  ...
  const nav: NavItem[] = [
    ...
    { label: 'Horoscope', href: '/features/horoscope' },
    { label: 'Tarot Card', href: '/features/tarotHome' },
    { label: 'Palm Reading', href: '/features/palmistry' },
    { label: 'Natal Chart', href: '/features/natalChart' },
    { label: 'Compatibility', href: '/features/compatibility' },
